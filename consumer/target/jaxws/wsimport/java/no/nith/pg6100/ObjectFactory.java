 ...
 * generated in the no.nith.pg6100 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ValidateResponse_QNAME = new QName("http://pg6100.nith.no/", "validateResponse");
    private final static QName _Validate_QNAME = new QName("http://pg6100.nith.no/", "validate");
    private final static QName _CreditCard_QNAME = new QName("http://pg6100.nith.no/", "creditCard");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: no.nith.pg6100
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pg6100.nith.no/", name = "validateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pg6100.nith.no/", name = "validate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pg6100.nith.no/", name = "creditCard")
